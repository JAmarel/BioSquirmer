% Computes and compares the swimming speed vs radius between the boundary element approach and the numerical reciprocal theorem.

% Active and Inactive disks must have velocity in the same direction (x)

% 1 
tic
n = 5; %Number of radii to sample
